 ...
 * 数字手写输入View
 */
class DigitalHandWritingInputView(context: Context, attrs: AttributeSet) : View(context, attrs), View.OnTouchListener {
    ...
    private var actionUpListener: IActionUpListener? = null
    ...
    fun setActionUpListener(listener: IActionUpListener) {
